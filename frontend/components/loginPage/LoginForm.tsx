          ...
          <div className="min-h-3.5 bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="text-center">
              <p className="mt-3 text-sm text-gray-900 dark:text-gray-400">
                <Link href="/register" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-400">Register</Link>
              </p>
            </div>
            <div className="text-center">
              <p className="mt-3 text-sm text-gray-900 dark:text-gray-400">
                <a href="#" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-400">Forgot your password?</a>
              </p>
            </div>
          </div>
        </div>
